...
def Label(parent: tk.Frame, text: str, justify: str ='center', anchor: str = None, width: int = None, height: int = None, font = Style.Get().FONT_TEXT, bg: int = -1, fg: int = 0):
    return tk.Label(parent, text=text, justify=justify, anchor=anchor, width=width, height=height, font=font, bg=_GetLabelBackground(bg), fg=_GetTextForeground(fg))

def MonoLabel(parent: tk.Frame, text: str, justify: str ='center', anchor: str = None, width: int = None, height: int = None, font = Style.Get().FONT_TEXT_MONO, bg: int = -1, fg: int = 0):
    return Label(parent, text=text, justify=justify, anchor=anchor, width=width, height=height, font=font, bg=bg, fg=fg)

def Title(parent: tk.Frame, text: str, justify: str ='center', anchor: str = None, width: int = None, height: int = None, font = Style.Get().FONT_TITLE, bg: int = -1, fg: int = 0):
    return Label(parent, text=text, justify=justify, anchor=anchor, width=width, height=height, font=font, bg=bg, fg=fg)

def SmallLabel(parent: tk.Frame, text: str, justify: str ='center', anchor: str = None, width: int = None, height: int = None, font = Style.Get().FONT_TEXT_SMALL, bg: int = -1, fg: int = 0):
    return Label(parent, text=text, justify=justify, anchor=anchor, width=width, height=height, font=font, bg=bg, fg=fg)

def LargeLabel(parent: tk.Frame, text: str, justify: str ='center', anchor: str = None, width: int = None, height: int = None, font = Style.Get().FONT_TEXT_LARGE, bg: int = -1, fg: int = 0):
    return Label(parent, text=text, justify=justify, anchor=anchor, width=width, height=height, font=font, bg=bg, fg=fg)
